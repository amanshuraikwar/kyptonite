package io.github.amanshuraikwar.multiitemlistadapter.annotationprocessor
    ...
    fun getListItems(roundEnv: RoundEnvironment): List<TypeElement> {
        return roundEnv.getElementsAnnotatedWith(ListItem::class.java).map { classElement ->
            ...
            (classElement as TypeElement)
                .interfaces
                .find {
                    it.toString() == "io.github.amanshuraikwar.multiitemlistadapter.RecyclerViewListItem"
                }
                ?:
                run {
                    throw InvalidAnnotationException(
    ...
    private fun generateTypeFactory(listItems: List<TypeElement>): TypeSpec {
        ...
        val typeFactoryClassBuilder =
            TypeSpec
                ...
                .addSuperinterface(
                    ClassName.bestGuess(
                        "io.github.amanshuraikwar.multiitemlistadapter.RecyclerViewTypeFactory"
                    )
                )
    ...
    private fun generateType(listItems: List<TypeElement>): FunSpec {
        ...
        val typeFunBuilder =
            FunSpec
                ...
                .addParameter("listItem", ClassName.bestGuess("io.github.amanshuraikwar.multiitemlistadapter.RecyclerViewListItem"))
